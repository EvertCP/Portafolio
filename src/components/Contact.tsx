  ...
  const contactInfo = [
    {
      icon: <FaEnvelope />,
      title: "Email",
      content: "evert.carpo9@gmail.com",
      link: "mailto:evert.carpo9@gmail.com"
    },
    {
      icon: <FaMapMarkerAlt />,
      title: "Ubicación",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            ¿Tienes un proyecto en mente? Me encantaría saber de ti. ¡Hablemos!
          </p>
        </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold flex items-center justify-center gap-2 hover:shadow-lg transition-all"
              >
                <FaPaperPlane />
                Enviar Mensaje
              </motion.button>
